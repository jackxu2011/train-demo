...
public interface CoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=me.xuling.train.mybatis.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("me.xuling.train.mybatis.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set name = #{name,jdbcType=VARCHAR},",
          "price = #{price,jdbcType=BIGINT,typeHandler=me.xuling.train.mybatis.handler.MoneyTypeHandler},",
